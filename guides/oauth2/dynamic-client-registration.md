...
[`:oauth2_endpoint_register_gen_client_id_callback`](Asteroid.Config.html#module-oauth2_endpoint_register_gen_client_id_callback)
callback.
...
The client resource id is generated by the callback set by the
[`:oauth2_endpoint_register_gen_client_resource_id_callback`](Asteroid.Config.html#module-oauth2_endpoint_register_gen_client_resource_id_callback),
which defaults to `Asteroid.OAuth2.Register.generate_client_resource_id/2`.
