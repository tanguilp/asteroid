defmodule AsteroidWeb.AuthorizeControllerOIDCTest do
  ...
  test "Success - az code - simple request", %{conn: conn} do
    ...
    assert Scope.Set.equal?(
             Scope.Set.new(response["requested_scopes"]),
  ...
  test "Success - az code - acr requested in claims values (essential)", %{conn: conn} do
    params = %{
      ...
      "scope" => "openid",
      "claims" =>
        Jason.encode!(%{"id_token" => %{"acr" => %{"essential" => true, "values" => ["loa1"]}}})
    }
  ...
  test "Success - az code - acr requested in claims values (non essential)", %{conn: conn} do
    params = %{
      ...
      "response_type" => "code",
      "scope" => "openid",
      "claims" => Jason.encode!(%{"id_token" => %{"acr" => %{"values" => ["loa1"]}}})
    }
  ...
  test "Success - az code - acr requested in claims value (essential)", %{conn: conn} do
    params = %{
      ...
      "scope" => "openid",
      "claims" =>
        Jason.encode!(%{"id_token" => %{"acr" => %{"essential" => true, "value" => "loa1"}}})
    }
  ...
  test "Success - az code - acr requested in claims value (non essential)", %{conn: conn} do
    params = %{
      ...
      "response_type" => "code",
      "scope" => "openid",
      "claims" => Jason.encode!(%{"id_token" => %{"acr" => %{"value" => "loa1"}}})
    }
