defmodule Asteroid.TokenStore.GenericKV.Mnesia do
  @moduledoc """
  Mnesia implementation of the `Asteroid.TokenStore.GenericKV` behaviour

  ## Options
  The options (`Asteroid.TokenStore.GenericKV.opts()`) are:
  ...
  @behaviour Asteroid.TokenStore.GenericKV
