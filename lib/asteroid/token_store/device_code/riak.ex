defmodule Asteroid.TokenStore.DeviceCode.Riak do
  @moduledoc """
  Riak implementation of the `Asteroid.TokenStore.DeviceCode` behaviour
  ...
  ## Options
  The options (`Asteroid.TokenStore.DeviceCode.opts()`) are:
  ...
  - it installs a custom schema (`asteroid_token_store_device_code_riak_schema`)
  - it creates a new index (`asteroid_token_store_device_code_riak_index`) on the bucket
  ...
  @behaviour Asteroid.TokenStore.DeviceCode
  ...
  def install(opts) do
    ...
    with :ok <-
           Riak.Search.Schema.create(
             schema_name(),
             (:code.priv_dir(:asteroid) ++ '/riak/token_store_device_code_schema.xml')
             |> File.read!()
           ),
  ...
  @spec search(String.t(), Asteroid.TokenStore.DeviceCode.opts()) ::
  ...
  defp schema_name(), do: "asteroid_token_store_device_code_riak_schema"

  @doc false

  @spec index_name() :: String.t()

  def index_name(), do: "asteroid_token_store_device_code_riak_index"
end
