defmodule Asteroid.TokenStore.AccessToken.Riak do
  @moduledoc """
  Riak implementation of the `Asteroid.TokenStore.AccessToken` behaviour
  ...
  ```elixir
  iex(13)> Asteroid.TokenStore.AccessToken.Riak.search("sub_register:j* AND exp_int_register:[0 TO #{:os.system_time(:seconds)}]", opts)
