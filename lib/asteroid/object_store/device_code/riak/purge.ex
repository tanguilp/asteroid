defmodule Asteroid.ObjectStore.DeviceCode.Riak.Purge do
  @moduledoc false
  ...
  defp purge(opts) do
    ...
    case Asteroid.ObjectStore.DeviceCode.Riak.search(request, opts) do
      {:ok, device_code_ids} ->
        for device_code_id <- device_code_ids do
          # this causes Riak connection exhaustion, to investigate further
          # Task.start(Asteroid.ObjectStore.DeviceCode.Riak, :delete, [device_code_id, opts])
