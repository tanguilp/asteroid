defmodule Asteroid.Store.AuthorizationCode.Riak do
  @moduledoc """
  Riak implementation of the `Asteroid.Store.AuthorizationCode` behaviour
  ...
  @spec search(String.t(), Asteroid.Store.AuthorizationCode.opts()) ::
