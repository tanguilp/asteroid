defmodule Asteroid.Store.RefreshToken.Riak do
  @moduledoc """
  Riak implementation of the `Asteroid.Store.RefreshToken` behaviour
  ...
  ```elixir
  iex(13)> Asteroid.Store.RefreshToken.Riak.search("sub_register:j* AND exp_int_register:[0 TO #{:os.system_time(:seconds)}]", opts)
  {:ok, ["7WRQL4EAKW27C5BEFF3JDGXBTA", "WCJBCL7SC2THS7TSRXB2KZH7OQ"]}
  ```
  """

  @spec search(String.t(), Asteroid.Store.RefreshToken.opts()) ::
