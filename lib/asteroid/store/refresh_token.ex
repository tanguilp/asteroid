defmodule Asteroid.Store.RefreshToken do
  ...
  1. A module that implements the `Asteroid.Store.AccessToken` behaviour
  2. Options for this module

  Implementation of this callback shall call the
  `c:Asteroid.Store.AccessToken.delete_from_refresh_token_id/2` callback so as to delete
