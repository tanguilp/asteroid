defmodule Asteroid.Store.DeviceCode.Riak do
  @moduledoc """
  Riak implementation of the `Asteroid.Store.DeviceCode` behaviour
  ...
  @spec search(String.t(), Asteroid.Store.DeviceCode.opts()) ::
