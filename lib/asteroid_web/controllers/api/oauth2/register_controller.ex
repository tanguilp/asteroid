defmodule AsteroidWeb.API.OAuth2.RegisterController do
  ...
  def handle(conn, input_metadata) do
    ...
    maybe_client_secret_and_hash =
      if processed_metadata["token_endpoint_auth_method"] == "client_secret_basic" or
           processed_metadata["token_endpoint_auth_method"] == "client_secret_post" do
        Expwd.Hashed.gen()
      end
    ...
    _ in Scope.Set.InvalidScopeParam ->
      AsteroidWeb.Error.respond_api(
        conn,
        InvalidClientMetadataFieldError.exception(
          field: "scope",
                ...
                if Enum.all?(redirect_uris, &(&1 in loaded_redirect_uris)) do
                  ...
                  {:error,
                   InvalidClientMetadataFieldError.exception(
                     ...
                     reason:
                       "sector identifier URI redirect URIs not all included in" <>
  ...
  defp process_oidc_sector_identifier_uri(
         processed_metadata,
         %{"sector_identifier_uri" => sector_identifier_uri}
       ) do
    case verify_sector_identifier_uri(
  ...
  defp process_oidc_require_auth_time(processed_metadata, %{
  ...
  defp process_oidc_default_acr_values(processed_metadata, %{
